...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2023 at 10:33 AM
...
CREATE TABLE `data` (
  `wanita` int(20) NOT NULL,
  `pria` int(20) NOT NULL
...
INSERT INTO `data` (`wanita`, `pria`) VALUES
(10, 11);
...
INSERT INTO `konfirmasi` (`voter_id`, `email`, `voted`) VALUES
('7372030207040001', 'gosalandika123@gmail.com', '');
...
(1, 'Andika ', 'Gosal', 'admin@gmail.com', 'gosal123'); 
...
INSERT INTO `tbcandidates` (`candidate_id`, `candidate_name`, `candidate_cvotes`) VALUES
(1, 'Prabowo Subianto', 19),
(2, 'Ganjar Pranowo', 204),
(3, 'Anies Baswedan', 3);
